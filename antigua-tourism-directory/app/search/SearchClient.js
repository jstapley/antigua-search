    ...
    <>
      <div className="flex justify-between items-center mb-6">
        ...
        {(filters.category || filters.parish || filters.sortBy !== 'relevance') && (
          <button onClick={clearFilters} className="text-sm text-indigo-600 hover:text-indigo-700 font-semibold">
            Clear
          </button>
        )}
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto">
            <div className="relative flex items-center">
              ...
              />
              <button type="submit" className="absolute right-2 bg-yellow-400 text-indigo-900 px-4 md:px-8 py-2 md:py-3 rounded-full font-bold text-sm md:text-lg hover:bg-yellow-300 transition shadow-lg">
                Search
              </button>
            </div>
          </form>
          ...
          {mobileFiltersOpen && (
            <div className="fixed inset-0 bg-black/50 z-50 lg:hidden" onClick={() => setMobileFiltersOpen(false)}>
              <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl p-6 max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                ...
                <FilterControls />
                <button onClick={() => setMobileFiltersOpen(false)} className="w-full bg-indigo-600 text-white py-3 rounded-lg font-bold mt-6 hover:bg-indigo-700 transition">
                  Apply Filters
                </button>
              </div>
            </div>
            ...
            {!query && !loading && (
              <div className="bg-white rounded-xl border-2 border-gray-200 p-8 md:p-12 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl mx-auto">
                  <Link href="/categories" className="bg-indigo-50 hover:bg-indigo-100 border-2 border-indigo-200 rounded-lg p-6 transition group">
            ...
            {!loading && results.length === 0 && query && (
              <div className="bg-white rounded-xl border-2 border-gray-200 p-8 md:p-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  <button onClick={clearFilters} className="bg-indigo-600 text-white px-6 py-2 rounded-lg font-semibold hover:bg-indigo-700 transition">Clear Filters</button>
                ...
                <div className="border-t border-gray-200 pt-8 mt-8">
                  ...
                  <div className="flex flex-wrap gap-3 justify-center">
                    ...
                    <Link href="/categories" className="bg-indigo-100 hover:bg-indigo-200 px-4 py-2 rounded-full text-sm font-semibold text-indigo-700 transition">All Categories →</Link>
                  </div>
                </div>
              </div>
            )}
