    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="flex gap-6 items-center">
              ...
              <Link href="/categories" className="text-indigo-600 font-semibold">Categories</Link>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {categories.map((category) => (
            ...
            >
              ...
              <div className="text-indigo-600 font-bold text-sm group-hover:translate-y-1 transition-transform">
                Explore ↓
              </div>
            </Link>
          ))}
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Discover Antigua by Category</h2>
